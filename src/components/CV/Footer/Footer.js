    ...
    return (
        <div>
            <div className="container">
                <div className="row">
                    <div className="col-2">
                        <ExternalLink href="https://github.com/spiritcodefire" className="text-dark">
                    ...
                    <div className="col-8">
                        <p className="taillePheader font-weight-bold">
                            ...
                            <ExternalLink href="http://dis-moi-oui.com//" className="text-dark"> <p className="fsize" >Dis-moi-oui.com</p></ExternalLink>
                    ...
                    <div className="col-2">
                        <ExternalLink href="https://api.whatsapp.com/send?phone=972532338015" className="text-dark">
