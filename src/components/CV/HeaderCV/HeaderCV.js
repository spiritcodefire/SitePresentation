            ...
            <div className="row justify-content-between">
                ...
                <div className="col-8 col-xs-12">
                    <div className="text-left m-3 ">
                        ...
                        <div class="btn-group dropright d-inline">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe mb-2" viewBox="0 0 16 16">
                            ...
                            <div className="dropdown-item" href="#">hebreu</div>
                            </div>
                        </div>
                ...
                <div className="col-2 col-xs-12">
                    <figure className="figure ">
                        <img className="figure-img img-fluid kenburns-left" src={bogoss} height="100px" alt="miniature" />
